...
export default function Privacy() {
  return (
    <Layout className={styles.contacts3}>
        <div className={styles.padding}>
        <Box className={styles.container} > 
            <p className={styles.contacts1}>Privatumo politika</p>
            <p className={styles.contacts3}>
                Mes suvokiame ypatingą svarbą, tenkančią Jūsų asmens duomenų apsaugai, 
                todėl renkame ir tvarkome tik tuos Jūsų duomenis, kurie reikalingi 
                vykdant mūsų veiklą. Asmens duomenis mes tvarkome teisėtai, 
                skaidriai ir sąžiningai, iš anksto nustatytais tikslais ir 
                tik tokia apimtimi, kuri reikalinga tikslams pasiekti. 
                Tvarkydami asmens duomenis, siekiame, kad jie būtų tikslūs, 
                saugūs, konfidencialūs, tinkamai laikomi ir saugomi.
            </p>
                ...
                <ol className={styles.olStyle} start="2">
                Kas mes?
                    <ul>
                        <li className={styles.ilStyle}>
                            Mes esame maxSveikata kuri yra max komandos kuriama sveikatos svetaine
                        </li>
                        <li className={styles.ilStyle}>
                            Remiantis teises aktu nuostatomis, mes esame jusu asmens duomenu valdytojas
                        </li>
                        </ul>
                </ol>

                <ol className={styles.olStyle} start="3">
                Kas yra sis dokumentas?
                    <ul >
                        <li className={styles.ilStyle}>
                        Ši privatumo politika (toliau – Privatumo politika) nustato privatumo sąlygas Jums naudojantis interneto svetaine maxSveikata.lt (toliau – Svetainė) taip pat Jums naudojantis teikiamomis sveikatos priežiūros paslaugomis mūsų sveikatos priežiūros įstaigose (toliau gali būti vadinamos klinikomis).
                        </li>
                        <li className={styles.ilStyle}>
                ...
                <ol className={styles.olStyle} start="4">
                    Kokiu principu mes laikomes?
                    <ul>
                        <li className={styles.ilStyle}>
                ...
                <ol className={styles.olStyle} start="5">
                    Kokiais tikslais renkame informacija?
                    <ul>
                        <li className={styles.ilStyle}>
                        ...
                        <li className={styles.ilStyle}>
                        vykdydami pareigas, susijusias su maxSveikata informacinės sistemos naudojimu;
                        </li>
                        <li className={styles.ilStyle}>
                ...
                <ol className={styles.olStyle} start="6"> 
                    Kaip mes naudojame slapukus?
                    <ul>
                        <il className={styles.ilStyle}>
                        ...
                        <li className={styles.ilStyle}>
                            Svetainėje gali buti naudojami šie slapukai: techniniai slapukai – tai slapukai, kurie yra būtini Svetainės veikimui;
                ...
                <table className={styles.tableStyle2}>
                    <tr className={styles.tableStyle2}>
                        <td>Naudojimo vieta</td>
                        <td>Pavadinimas</td>
                        <td>Paskirtis</td>
                        <td>Sukurimo momentas</td>
                ...
                <ol className={styles.olStyle} start="7">
                ...
                <ol className={styles.olStyle} start="8">
                Kiek laiko mes saugome Jūsų asmens duomenis?
                    <ul>
                        ...
                        <li className={styles.ilStyle}>
                        siekdami tobulinti Svetainę, pasiūlyti Jums geresnes ir Jums pritaikytas paslaugas surinktus duomenis saugome ne ilgiau nei šios Privatumo politikos slapukų lentelėje nurodytą terminą.
                        </li>
                        <li className={styles.ilStyle}>
                        tiesioginės rinkodaros tikslu surinktus duomenis saugome tol, kol esate prisirašęs (-usi) prie mūsų sveikatos priežiūros įstaigos arba kol atšaukiate savo sutikimą tiesioginei rinkodarai. Jeigu nesate prisirašęs (-usi) prie mūsų sveikatos priežiūros įstaigos, tačiau kitais šioje Privatumo politikoje nurodytais būdais sutikote su Jūsų duomenų tvarkymu tiesioginės rinkodaros tikslu, tokiu atveju, Jūsų asmens duomenis saugome ne ilgiau kaip 3 metus nuo Jūsų sutikimo davimo dienos.
                        </li>
                        <li className={styles.ilStyle}>
                        Siekdami kokybiškų paslaugų teikimo ir prašymų nagrinėjimo telefoninio pokalbio metu, pokalbių įrašus saugome ne ilgiau kaip 6 mėnesius.
                        </li>
                        <li className={styles.ilStyle}>
                ...
                <ol className={styles.olStyle} start="9">
                ...
                <ol className={styles.olStyle} start="10">
